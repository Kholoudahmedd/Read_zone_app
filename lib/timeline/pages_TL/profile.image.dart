...
//   Future<void> loadFavoritePostIds() async {
//     setState(() {
//       isFavLoading = true;
//     });

//     try {
//       final ids = await ApiService.getFavoritePostIds();
//       if (mounted) {
//         setState(() {
//           favoritePostIds = ids;
//           isFavLoading = false;
...
//       }
//     } catch (e) {
//       print('Error loading favorite post IDs: $e');
//       setState(() {
//         isFavLoading = false;
//       });
//     }
...
//                 child: TabBarView(
//                   children: [
//                     // My Posts tab (كما هي بدون تغيير)
...
//                     // Favourites tab: نعرض IDs بشكل بسيط
//                     isFavLoading
//                         ? const Center(child: CircularProgressIndicator())
//                         : favoritePostIds.isEmpty
//                             ? const Center(
...
//                                   return ListTile(
//                                     title: Text(
//                                         'Favorite Post ID: ${favoritePostIds[index]}'),
//                                   );
//                                 },
//                               ),
//                   ],
...
//                     // Favourites tab: show full posts
//                     isFavLoading
//                         ? const Center(child: CircularProgressIndicator())
          ...
          child: Column(
            children: [
              TabBar(
                ...
                indicatorColor: getRedColor(context),
                tabs: const [Tab(text: "Posts"), Tab(text: "Favourites")],
                dividerColor: Colors.transparent, // لإخفاء الخط الفاصل
              ),
              Expanded(
                child: TabBarView(
                  children: [
                          ...
                          itemBuilder: (context, index) {
                            return PostWidget(
                              ...
                              onDelete: () async {
                                ...
                                if (success) {
                                  setState(() {});
                                  loadFavoritePosts(); // حدث الفيفوريت بعد الحذف
                                }
                              },
                              onFavoriteChanged: (newStatus) {
                                // لو غيرت حالة الفيفوريت حدث القائمة
                                loadFavoritePosts();
                                setState(() {});
                              },
                              key: ValueKey(posts[index].id), // للتمييز
                            );
                          },
                        );
                      },
